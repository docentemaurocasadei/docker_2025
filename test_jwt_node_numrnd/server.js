...
function logToFile(message) {
  ...
  console.log(`[${time}] ${message}`); // Render raccoglie i log da console
}
// POST /login
...
// GET /random
app.get('/random', authenticateToken, (req, res) => {
    logToFile(`Accesso alla richiesta di un numero random: ${req.user.email} (ruolo: ${req.user.role})`);
